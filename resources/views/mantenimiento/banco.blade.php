    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Mantenimiento de Bancos</strong>
            </div>
            <div class="card-body">
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <div class="table-responsive table--no-card m-b-30">
                            <table class="table table-borderless table-data3" id="tblBancos" data-toggle="tblBancos">
                                <thead>
                                <tr>
...
@section('modal')
    <div class="modal fade" id="modalRegistroBanco" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formMantenimientoBanco" name="formMantenimientoBanco" autocomplete="off" onsubmit="return false;">
                        @csrf
                        <div class="row form-group">
                            <div class="col-md-12">
...
@section('scripts')
    <script type="text/javascript">
            ...
            'click .delete': function (e, value, row, index) {
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "{{ route('deleteBanco', 'idReg') }}".replace('idReg', row.id),
                            method: "POST",
                            data: {_token: _token},
                            dataType: 'json',
        ...
        CargarTablaBancos = function(){
            let _token = $('input[name="_token"]').val();
            $.ajax({
                url: "{{ route('listadoBanco') }}",
                method: "POST",
                data: {_token: _token},
                dataType: 'json',
                success: function (response) {
                    ...
                    if(response.code === 200){
                        $tabla.bootstrapTable({data: response.bancos,
        ...
        $('#btnRegistrar').click(function(){
            //Ingresar / Editar
            if ($("#formMantenimientoBanco").valid()) {
                let _token = $('input[name="_token"]').val();
                $.ajax({
                    url: "{{ route('saveBanco') }}",
                    method: "POST",
        ...
        if ($("#formMantenimientoBanco").length > 0) {
            $.validator.addMethod("valueNotEquals", function (value, element, arg) {
                return arg !== value;
            });

            $('#formMantenimientoBanco').validate({
                rules: {
                    nombre: {
                        required: true,
                        maxlength: 250
